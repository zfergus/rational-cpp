...
if(TARGET rational::warnings)
  return()
endif()

set(RATIONAL_WARNING_FLAGS
  -Wall
  -Wextra
  -pedantic
...
add_library(rational_warnings INTERFACE)
add_library(rational::warnings ALIAS rational_warnings)

include(rational_filter_flags)
rational_filter_flags(RATIONAL_WARNING_FLAGS)
target_compile_options(rational_warnings INTERFACE ${RATIONAL_WARNING_FLAGS})