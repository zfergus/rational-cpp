...
if("${CMAKE_CXX_COMPILER_ID}" STREQUAL "MSVC")
  ...
  set(RATIONAL_GLOBAL_FLAGS
      -fdiagnostics-color=always # GCC
      -fcolor-diagnostics # Clang
  )
  rational_filter_flags(RATIONAL_GLOBAL_FLAGS)
  message(STATUS "Adding global flags: ${RATIONAL_GLOBAL_FLAGS}")
  add_compile_options(${RATIONAL_GLOBAL_FLAGS})
endif()
